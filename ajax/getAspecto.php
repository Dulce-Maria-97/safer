...
<table id="aspecto" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          <th>Aaspecto</th>
                          <th>Estado</th>
                      ...
                      <?php
						if ($obj->conecta())
						{
							...
							while ($fila = sqlsrv_fetch_array($datos))
							{
								...
								if ($estado)
									echo $es= "<td class='edo mano success text-center' alt='$id_area' rel='$estado'><b><i class='fa fa-thumbs-o-up'></i> Activo</b></td>";	
								else
									echo $es= "<td class='edo mano danger text-center' alt='$id_area' rel='$estado'><b><i class='fa fa-thumbs-o-down'></i> Inactivo</b></td>";
				
								  echo "<td>";
								  echo "<button class='editar btn btn-round btn-info' alt='$id_area' rel='$nombre_area'>Editar</button>";
