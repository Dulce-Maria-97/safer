...
<table id="autonizacion" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          <th>Folio</th>
                          <th>Folio observacion</th>
                          <th>Plan de acción propuesto</th>
                          <th>Tiempo de solución</th>
                          <th>Consecuencias de no corregirlo</th>
...
$('#nuevo').on('click',function(){
	...
	$('#titulo').text('Registro de observación:');
	$('#pro').val('1');
	$('#edi').hide();
	$('#reg').show();
