      ...
      <div id="contenido" class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form id="formulario" class="" action="" method="post" novalidate>
               ...
               <!--trar  id_usuario--><input type="text" id="id_departamento" name="id_departamento" readonly style="visibility:hidden;"/>
                  ...
                  <div class="field item form-group">
                      <label class="col-form-label col-md-3 col-sm-3  label-align">Departamento<span class="required">*</span></label>
                         <div class="col-md-6 col-sm-6">
                          <input id="dep" class="form-control" data-validate-length-range="6" data-validate-words="2" name="dep" placeholder="" required="required" autocomplete="off"/>
                                            </div>
                                        </div>
