    ...
    <div class="modal-dialog modal-lg">
      <div id="contenido" class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form id="formulario" class="" action="" method="post" novalidate>
               ...
               <div class="field item form-group">  
                ...
                <span class="section">Datos Autorización</span>
        ...
        <div class="modal-footer">
          ...
          <button id="autorizar" type="button" class="btn btn-success">Autorizar</button>
          <button id="rechazar" type="button" class="btn btn-warning">Rechazar</button>
        </div>
