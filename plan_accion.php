          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Autorizaciones  <small>pendientes </small></h2>
               ...
               <div class="field item form-group">
                      <label class="col-form-label col-md-3 col-sm-3  label-align">Folio<span class="required">*</span></label>
                         <div class="col-md-6 col-sm-6">
                          <textarea required id="accion"  class="form-control"  name="p_accion" ></textarea>
                                            </div>
                                        </div>
                                        
                                        <div class="field item form-group">
                      <label class="col-form-label col-md-3 col-sm-3  label-align">Folio observacion<span class="required">*</span></label>
                         <div class="col-md-6 col-sm-6">
                          <textarea required id="oservacion"  class="form-control"  name="p_accion" ></textarea>
                                            </div>
                                        </div>
                  ...
                  <div class="field item form-group">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <input id="fecha" name="fecha" class="form-control" class='date' type="date" name="date"></div>
                </div>
