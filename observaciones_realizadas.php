          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Registro <small>Observaciones Realizadas</small></h2>
    ...
    <div class="modal-dialog modal-lg">
      <div id="contenido" class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button id="archivar" type="button" class="btn btn-success">Archivar</button>
          <button id="pedir_autorizacion" type="button" class="btn btn-success">Pedir Autorización</button>
          <button id="pedir_plan" type="button" class="btn btn-primary">Plan de Acción</button>
        </div>
          ...
          <form id="formulario_auto" class="" action="" method="post" novalidate>
           ...
           <div class="field item form-group">
                      ...
                      <label class="col-form-label col-md-3 col-sm-3  label-align">Presupuesto requerido<span class="required"></span></label>
                         <div class="col-md-6 col-sm-6">
                          <input type="text" id="presupuesto" class="form-control" name="presupuesto" onkeypress="return filterFloat(event,this);" />
                                            </div>
                                        </div>
          ...
          <form id="formulario_accion" class="" action="" method="post" novalidate>
               ...
               <span class="section">Plan Acción</span>
                  ...
                  <div class="field item form-group">
                      <label class="col-form-label col-md-3 col-sm-3  label-align">Definir plan de acción<span class="required">*</span></label>
                         <div class="col-md-6 col-sm-6">
                          <textarea required id="definir_p"  class="form-control"  name="definir_p" ></textarea>
                                            </div>
                    ...
                    <label class="col-form-label col-md-3 col-sm-3  label-align">Fecha compromiso<span class="required">*</span></label>
                    <div class="col-md-6 col-sm-6">
                        <input id="fecha_compromiso_p" name="fecha_compromiso_p" class="form-control" class='date' type="date" name="date"></div>
                </div>
...
<div id="archivado" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true" style="overflow-y: scroll;">
    <div class="modal-dialog modal-lg">
      <div id="contenido" class="modal-content">

        <div class="modal-header">
          <h4 class="modal-title">Fin de Observación</h4>
          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
          </button>
        </div>
        <div class="modal-body">
          ...
          <!--form-->
          <form id="formulario_observacion" class="" action="" method="post" novalidate>
                ...
                <input type="text" id="pro_pa" name="pro_pa" value="1" readonly style="visibility:hidden;"/>
                  ...
                  <div class="field item form-group">
                      <label class="col-form-label col-md-3 col-sm-3  label-align">Comentario<span class="required">*</span></label>
                         <div class="col-md-6 col-sm-6">
                          <textarea required id="com_final"  class="form-control"  name="com_final" ></textarea>
                                            </div>
                      
                                        </div>
                      <div class="field item form-group">
                    <label class="col-form-label col-md-3 col-sm-3  label-align">SELECCIONA FOTO<span class="required">*</span></label>
                    <div class="col-md-6 col-sm-6">
                        
                        <input type="file" name="archivoImage" id="archivoImage" class="inputfile" />
                        </div>
                </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
          <button id="archiva_final" type="button" class="btn btn-primary">Guardar</button>
        </div>
   ...
   <script src="vendors/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script src="js/observaciones_realizadas.js"></script>
