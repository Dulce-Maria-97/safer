...
function recarga()
{
	...
	$("#datos").load('ajax/getObservacionesHistorico.php', {id_usuario: $("#id_usuario").val()},function(response,status,xhr){
		if(status == 'success')
		{
...
function validacampos_plan()
{
	...
	if($("#definir").val()==0){
		$("#definir").addClass("alert-danger");$pen=0; }
	
	if($("#fecha_compromiso").val()==0){
	$("#fecha_compromiso").addClass("alert-danger"); $pen=0; }
