      ...
      <div id="contenido" class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form id="formulario" class="" action="" method="post" novalidate>
               ...
               <!--trar  id_usuario--><input type="text" id="id_aspecto" name="id_aspecto" readonly style="visibility:hidden;"/>
               ...
               <span class="section">Información</span>
                  <div class="field item form-group">
                      <label class="col-form-label col-md-3 col-sm-3  label-align">Aspecto<span class="required">*</span></label>
                         <div class="col-md-6 col-sm-6">
                          <input id="aspecto" class="form-control" data-validate-length-range="6" data-validate-words="2" name="aspecto" placeholder="" required="required" autocomplete="off"/>
                                            </div>
                                        </div>
