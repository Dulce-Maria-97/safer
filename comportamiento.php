          ...
          <form id="formulario" class="" action="" method="post" novalidate>
               ...
               <span class="section">Información</span>
                  <div class="field item form-group">
                      <label class="col-form-label col-md-3 col-sm-3  label-align">Comportamiento<span class="required">*</span></label>
                         <div class="col-md-6 col-sm-6">
                          <input id="comportamiento" class="form-control" data-validate-length-range="6" data-validate-words="2" name="comportamiento" placeholder="" required="required" autocomplete="off"/>
                                            </div>
                                        </div>
